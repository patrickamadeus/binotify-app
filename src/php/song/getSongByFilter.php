...
if (!$filter_exist){
    $result = ["status" => "success", "description" => "EMPTY_QUERY"];
...
$result = pg_query($conn, "$query_string LIMIT 10 OFFSET 0");
...
$result = ["status" => "success", "description" => "SONG_FOUND", "payload" => $payload, "page_link" => $page_link_html];
http_response_code(200);
